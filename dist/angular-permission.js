...
(function () {
    ...
    angular.module('permission', ['ui.router'])
        .provider('Permission', function () {
            ...
            var validateDefaultValidationParams = function (validationFunction) {
                if (!angular.isFunction(validationFunction)) {
                    throw new Error('Validation function not provided correctly');
                }
            };
            ...
            this.$get = ['$q', function ($q) {
                var Permission = {
                    ...
                    defineDefaultValidationFunction: function (validationFuntion) {
                        validateDefaultValidationParams(validationFuntion);
                        roleValidationConfig.defaultValidationFunction = validationFuntion;
                    },
